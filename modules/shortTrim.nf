...
process shortTrim {
    ...
    // This script performs automated adapter detection and remove, 5' trimming, a front-to-tail scan for trimming with a 4 bp window (both with a quality score cutoff of 20), removes all reads smaller than 35 bp, and removes the last base from both the forward and reverse reads
    script:
    """
