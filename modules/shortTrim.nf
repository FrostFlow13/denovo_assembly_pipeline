...
process shortTrim {
    ...
    script:
    """
    fastp -j ${samples[0]}_fastp.json -h ${samples[0]}_fastp.html -5 -r -l 35 -t 1 -T 1 -i ${srdir}/${samples[1]} -I ${srdir}/${samples[2]} -o ${samples[0]}_R1_trim.fastq.gz -O ${samples[0]}_R2_trim.fastq.gz
    """
}
